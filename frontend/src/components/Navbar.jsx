...
export default function Navbar() {
  const { isConnected, account, truncateAddress, connect, disconnect, isConnecting } = useWallet()
                ...
                {walletOpen && (
                  <>
                    ...
                    <div style={{
                      ...
                      <div style={{ fontSize: 12, fontFamily: 'monospace', wordBreak: 'break-all', marginBottom: 12, color: 'var(--text)', lineHeight: 1.5 }}>{account}</div>
                      <button className="btn btn-outline" style={{ width: '100%', justifyContent: 'center', fontSize: 13, color: '#b91c1c', borderColor: 'rgba(220,38,38,0.25)' }}
      ...
      {mobileOpen && (
        <div className="nav-mobile-menu open">
          ...
          <div style={{ paddingTop: 16 }}>
            {isConnected ? (
              <div>
                <div style={{ fontSize: 12, color: 'var(--ink-dim)', marginBottom: 8, fontFamily: 'monospace' }}>{account}</div>
                <button className="btn btn-outline" style={{ width: '100%', justifyContent: 'center', color: '#b91c1c', borderColor: 'rgba(220,38,38,0.25)' }}
